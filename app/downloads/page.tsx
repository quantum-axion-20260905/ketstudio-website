...
export default function DownloadsPage() {
  ...
  return <>
    ...
    <section className="section container platform-section">
      ...
      <div className="platform-grid"><div className="platform-card available"><span>WINDOWS</span><strong>Available now</strong><small>{uz ? "MSIX + EXE · x64" : "MSIX + EXE · x64"}</small></div><div className="platform-card"><span>LINUX</span><strong>Planned</strong><small>{uz ? "Release hali mavjud emas" : "No release yet"}</small></div><div className="platform-card"><span>MACOS</span><strong>Planned</strong><small>{uz ? "Release hali mavjud emas" : "No release yet"}</small></div></div>
    </section>
