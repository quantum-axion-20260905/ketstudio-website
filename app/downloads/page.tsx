...
export default function DownloadsPage() {
  ...
  return <>
    <PageIntro eyebrow="RELEASES · WINDOWS DESKTOP" title={uz ? <>KET Studio’ni <span className="gradient-text">yuklab oling.</span></> : <>Download KET Studio for <span className="gradient-text">Windows.</span></>} description={uz ? "v1.3.0 Windows 10/11 x64 uchun tayyor. MSIX asosiy paket, EXE esa sertifikat trust mavjud bo‘lmagan kompyuterlar uchun fallback installer." : "v1.3.0 is ready for Windows 10/11 x64. MSIX is the primary package; EXE is the fallback when certificate trust is unavailable."} />
    <section className="section container download-grid">
      <article className="download-card primary-download">
        <div className="download-card-top"><span>WINDOWS 10/11 · X64</span><span>v1.3.0</span></div>
        <h2>MSIX package</h2>
        ...
        <small>{uz ? "Windows desktop · x64 · 1.3.0.0" : "Windows desktop · x64 · 1.3.0.0"}</small>
      ...
      <article className="download-card">
        ...
        <p>{uz ? "Per-user Inno Setup installer. MSIX certificate trust muammosi bo‘lsa yoki pilot foydalanuvchiga qulay o‘rnatish kerak bo‘lsa ishlating." : "Per-user Inno Setup installer. Use it when MSIX certificate trust is unavailable or a pilot needs a familiar setup flow."}</p>
