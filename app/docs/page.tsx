    ...
    <section className="section container docs-layout">
      ...
      <div className="docs-content">
        ...
        <article id="artifacts">
          ...
          <ul className="docs-list"><li>{uz ? "Event yuborishdan oldin fayl yozilib bo‘lgan bo‘lsin." : "Make sure the file exists before sending the event."}</li><li>{uz ? "Artifact’ni grant yoki publication uchun saqlamoqchi bo‘lsangiz `.ket/out`ni project bilan birga commit yoki archive qiling." : "If an artifact matters for a grant or publication, commit or archive `.ket/out` with the project."}</li><li>{uz ? "Katta raw figure’ni diskka saqlang, UI’ga esa kerakli preview’ni yuboring." : "Keep large raw figures on disk and send a useful preview to the UI."}</li></ul>
        </article>
